...
// Add an Enum for the submission type


enum DocumentSubmissionType { onlineForm, upload, either }
// Refactor lib/core/database/tables/template_documents.dart
...
class TemplateDocuments extends Table {
  ...
  // NEW: Capture the type of submission
  IntColumn get submissionType => intEnum<DocumentSubmissionType>()();
}